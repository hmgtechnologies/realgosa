...
window.SCHOOL = {
  ...
  font:    'roboto',
  fontFamily: 'Roboto',
  fontCss: 'Roboto:wght@300;400;500;600;700',
  layout:  'layout1',
  modules: ["academic_setup","students","staff","classes","subjects","attendance","results","timetable","sow","cbt","cbt-prompts","report-cards","timetable-generator","checkin","assignments","library","digital_library","conduct","health","promotion","lms","gamification","career_counseling","lesson_plans","behaviour","substitutions","support_plans","entrance","storage","analytics","approvals","admin-data","settings","admissions","hr","payroll","staff_loans","staff_bonus","appraisals","hostel","alumni","inventory","certificates","document_builder","fleet_tracking","facility_booking","compliance","activity_log","academic_records","developer","diary","surveys","announcements","events","messages","inbox","complaints","broadcast","voting","parent_meeting","front_desk","helpdesk","menu","gallery","eresources","birthdays","idcards","flyer","reports","directory","departments","parents","school_calendar","lost_found","book_request","fees","finance","leave","visitors","transport","cafeteria","financial_aid","payments_online","rubrics","transcripts","transfer_cert","counselling"],
